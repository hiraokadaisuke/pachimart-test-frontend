      ...
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        <div className="space-y-4">
          {leftSections.map((section) => (
            <section key={section.title} className="rounded-lg border border-slate-300 bg-white shadow-sm">
              ...
              <div className="px-4 py-3 text-sm text-neutral-900">{section.content}</div>
            </section>
          ))}
        </div>
