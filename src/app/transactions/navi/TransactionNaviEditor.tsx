          ...
          <div className="rounded-lg border border-slate-300 bg-white text-sm shadow-sm">
            ...
            {isProductLinked ? (
              ...
              <div className="space-y-3 p-4 text-sm text-neutral-900">
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-neutral-800">設置場所</label>
                  <input
                    type="text"
                    className="w-full rounded border border-slate-300 px-3 py-2 text-sm"
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    min={1}
                    onChange={(e) => handlePropertyChange("quantity", Number(e.target.value) || 1)}
                  />
                </div>
              </div>
            )}
          ...
          <div className="rounded-lg border border-slate-300 bg-white shadow-sm">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm">
                <tbody>
                  <EditRow label="売却先" required>
                    <div className="flex flex-col gap-1 text-neutral-700">
                      <div className="flex items-center gap-2 text-sm">
                        <span className="font-semibold">{displayBuyer.companyName}</span>
                        {displayBuyer.contactPerson && (
                          <span className="rounded-full bg-slate-100 px-3 py-1 text-[11px] text-neutral-800">
                            {displayBuyer.contactPerson}
                          </span>
                        )}
                      </div>
                      <div className="flex flex-wrap items-center gap-3 text-xs text-neutral-600">
                        <span className="flex items-center gap-1">
                          ...
                          <span>{displayBuyer.phoneNumber}</span>
                        </span>
                        <span className="flex items-center gap-1">
                          <span className="inline-block h-1.5 w-1.5 rounded-full bg-sky-500" aria-hidden />
                          <span>{displayBuyer.email}</span>
                        </span>
                        <span className="flex items-center gap-1">
                          <span className="inline-block h-1.5 w-1.5 rounded-full bg-amber-500" aria-hidden />
                          <span>{displayBuyer.address}</span>
                        </span>
                      </div>
                      {displayBuyer.notes && (
                        <p className="text-xs text-neutral-600">メモ: {displayBuyer.notes}</p>
                      )}
                    </div>
                    {isBuyerSet ? (
                      <button
                  ...
                  <EditRow label="物件情報" required>
                    <div className="space-y-2 text-neutral-700">
                      <div className="text-sm font-semibold text-slate-900">{propertyInfo.modelName}</div>
                      <div className="flex flex-wrap items-center gap-3 text-xs text-neutral-600">
                        <span className="flex items-center gap-1">
                        ...
                        <span className="flex items-center gap-1">
                          <span className="inline-block h-1.5 w-1.5 rounded-full bg-fuchsia-500" aria-hidden />
                          <span>{propertyPrevLocation}</span>
                        </span>
                        <span className="flex items-center gap-1">
                          <span className="inline-block h-1.5 w-1.5 rounded-full bg-emerald-500" aria-hidden />
                        ...
                        <span className="flex items-center gap-1">
                          <span className="inline-block h-1.5 w-1.5 rounded-full bg-orange-500" aria-hidden />
                          <span>{propertyRemovalDateLabel}</span>
                        </span>
                      </div>
                      <div className="text-xs text-neutral-600">備考: {propertyNote}</div>
                    </div>
                    <button type="button" className="text-sm font-semibold text-sky-700 underline-offset-2 hover:underline">
                      物件情報を変更
                    </button>
                  </EditRow>

                  <EditRow label="売却単価" required>
                    <div className="flex flex-col gap-1 text-neutral-700">
                      <span className="text-xs">最新</span>
                      <span className="text-sm font-semibold text-slate-900">{formattedNumber(referenceConditions.price)}</span>
                    </div>
                    <div className="flex flex-col items-start gap-1">
                      ...
                      />
                      <p className="text-xs text-neutral-500">1台あたりの単価 (税別)</p>
                  ...
                  <EditRow label="台数" required>
                    <div className="flex flex-col gap-1 text-neutral-700">
                      <span className="text-xs">最新</span>
                      <span className="text-sm font-semibold text-slate-900">{referenceConditions.quantity}台</span>
                    </div>
                    <div className="flex flex-col items-start gap-1">
                      <input
                        type="number"
                      ...
                      />
                      <p className="text-xs text-neutral-500">取引する台数</p>
                      {validationErrors.quantity && <p className="text-sm text-red-600">{validationErrors.quantity}</p>}
                    </div>
                  </EditRow>
                  ...
                  <EditRow label="撤去日">
                    <div className="flex flex-col gap-1 text-neutral-700">
                      <span className="text-xs">最新</span>
                      <span className="text-sm font-semibold text-slate-900">{referenceConditions.removalDate}</span>
                    </div>
                    <div className="flex flex-col items-start gap-1">
                      <input
                        type="date"
                      ...
                      />
                      <p className="text-xs text-neutral-500">撤去予定日</p>
                    </div>
                  </EditRow>
                  ...
                  <EditRow label="機材発送">
                    <div className="flex flex-col gap-1 text-neutral-700">
                      <span className="text-xs">最新</span>
                      <span className="text-sm font-semibold text-slate-900">{referenceConditions.machineShipmentDate}</span>
                      <span className="text-xs text-neutral-600">{referenceConditions.machineShipmentType}</span>
                    </div>
                    <div className="flex flex-col gap-2 text-sm text-neutral-800">
                      ...
                      {renderRadioGroup("machineShipmentType", ["持込", "発送"], editedConditions.machineShipmentType, (value) =>
                        handleTextConditionChange("machineShipmentType", value)
                      )}
                    </div>
                  </EditRow>
                  ...
                  <EditRow label="書類発送">
                    <div className="flex flex-col gap-1 text-neutral-700">
                      <span className="text-xs">最新</span>
                      <span className="text-sm font-semibold text-slate-900">{referenceConditions.documentShipmentDate}</span>
                      <span className="text-xs text-neutral-600">{referenceConditions.documentShipmentType}</span>
                    </div>
                    <div className="flex flex-col gap-2 text-sm text-neutral-800">
                      <div className="flex flex-wrap items-center gap-2">
                        <input
                      ...
                      {renderRadioGroup(
                        ...
                        (value) => handleTextConditionChange("documentShipmentType", value)
                      )}
                    </div>
                  </EditRow>
                  ...
                  <EditRow label="支払期日" required>
                    <div className="flex flex-col gap-1 text-neutral-700">
                      <span className="text-xs">最新</span>
                      <span className="text-sm font-semibold text-slate-900">{referenceConditions.paymentDue}</span>
                    </div>
                    <div className="flex flex-col items-start gap-1">
                      <input
                        type="text"
                      ...
                      />
                      <p className="text-xs text-neutral-500">例: 納品後7日以内、月末締め翌月末払いなど</p>
                    </div>
                  </EditRow>
                  ...
                  <EditRow label="送料">
                    <div className="flex flex-col gap-1 text-neutral-700">
                      <span className="text-xs">最新</span>
                      <span className="text-sm font-semibold text-slate-900">{formattedNumber(referenceConditions.freightCost)}</span>
                    </div>
                    <div className="flex flex-col items-start gap-1">
                      <input
                        type="number"
                  ...
                  <EditRow label="出庫手数料">
                    <div className="flex flex-col gap-1 text-neutral-700">
                      <span className="text-xs">最新</span>
                      <span className="text-sm font-semibold text-slate-900">{formattedNumber(referenceConditions.handlingFee)}</span>
                    </div>
                    <div className="flex flex-col items-start gap-1">
                      <input
                        type="number"
