...
const APPLICATION_OPTIONS = ["", "道商A", "道商B", "不要"];
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-neutral-900">業者伝票登録</h1>
          <p className="text-sm text-neutral-600">選択した在庫の情報を確認し、伝票を保存します。</p>
        </div>
        <Link
          ...
          <table className="min-w-full divide-y divide-slate-200 text-sm">
            <thead className="bg-slate-50 text-left text-xs font-semibold text-slate-700">
              <tr>
                ...
                <th className="px-3 py-3">申請道商</th>
                  ...
                  return (
                    <tr key={item.inventoryId} className="hover:bg-slate-50">
                      ...
                      <td className="px-3 py-3">
                        <select
                          value={detail?.applicationRoute ?? ""}
                          onChange={(event) =>
                            handleItemChange(item.inventoryId, "applicationRoute", event.target.value)
                          }
                      ...
                      <td className="px-3 py-3">
                        <input
                          ...
                          onChange={(event) =>
                            handleItemChange(item.inventoryId, "applicationDate", event.target.value)
                          }
