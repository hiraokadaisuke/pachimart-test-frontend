  ...
  return (
    <div className="space-y-3">
      <div className="grid gap-2 lg:grid-cols-3">
        <div className="flex flex-col justify-center rounded-md border border-slate-200 bg-white px-3 py-2 text-xs shadow-sm">
          <span className="text-[11px] font-semibold text-slate-600">合計金額</span>
          <span className="text-lg font-bold text-neutral-900">{totalAmount.toLocaleString()}円</span>
        </div>
        <label className="flex flex-col justify-between gap-1 rounded-md border border-slate-200 bg-white px-3 py-2 text-xs text-neutral-800 shadow-sm">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          <button
            type="submit"
            className="rounded border border-sky-600 bg-sky-600 px-4 py-1.5 text-xs font-semibold text-white shadow hover:bg-sky-500"
          >
            確認
          </button>
          <Link
            href="/purchase-invoices/create"
            className="rounded border border-slate-200 bg-white px-4 py-1.5 text-xs font-semibold text-neutral-800 shadow-sm"
          >
            戻る
          </Link>
        </div>
      ...
      <div className="grid gap-3 lg:grid-cols-[1.4fr_1fr]">
        <label className="space-y-1 text-xs text-neutral-800">
          ...
          <textarea
            ...
            className="min-h-[110px] w-full rounded border border-slate-300 bg-yellow-100 px-2 py-2 text-xs shadow-sm focus:border-sky-500 focus:outline-none"
          />
        </label>
          ...
          <div className="space-y-2 rounded border border-slate-200 bg-white p-3 text-xs text-neutral-800">
            <label className="flex items-center gap-2">
              ...
              <input
                ...
                placeholder="販売先を入力"
                className="h-7 flex-1 rounded border border-slate-300 bg-yellow-100 px-2 text-xs shadow-sm focus:border-sky-500 focus:outline-none"
              />
              <button
                type="button"
