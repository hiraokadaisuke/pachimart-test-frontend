...
export default async function StocktakeListPage() {
  ...
  return <main className="mx-auto max-w-[1400px] p-4"><div className="mb-3 flex justify-between"><h1 className="text-xl font-bold">棚卸一覧</h1><Link className="border px-3 py-1" href="/inventory/stocktakes/new">新規作成</Link></div>
