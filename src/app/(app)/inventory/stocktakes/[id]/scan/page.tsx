...
return <main className="mx-auto max-w-xl p-4"><h1 className="text-lg font-bold">棚卸スキャン</h1><form action={action} className="space-y-2"><input autoFocus name="displayCode" className="w-full border p-3" placeholder="現物番号 / Unit番号"/><input name="rawQr" className="w-full border p-3" placeholder="QR(補助)"/><input name="memo" className="w-full border p-3" placeholder="メモ"/><button className="w-full bg-emerald-700 text-white p-3">照合して保存</button></form>
